 ...
 * @version 1.00 - 05/15
 */
public class ActionAllowInteractivity extends AAction
{
...
//== CONSTANT INSTANCE ATTRIBUTES ==============================================
    ...
    /* název akce */
    private String NAME = "allowInteractivity";
...
//== CONSTUCTORS AND FACTORY METHODS ===========================================
     ...
     */
    public ActionAllowInteractivity(){
    ...
    public void execute(String gameObjectId) {
        ...
        if(gameObject instanceof AGameObject){
            ...
            try {
                ...
                Logger.getLogger(ActionAllowInteractivity.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
